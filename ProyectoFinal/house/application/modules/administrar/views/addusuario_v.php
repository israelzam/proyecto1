    ...
    <section class="content">
      <div class="row center-block">
        <div class="col-md-6">
            ...
            <!-- form start -->
            <form role="form" method="post" action="<?php echo base_url(); ?>administrar/usuarios/addUsuario">         
            <div class="box-body">
            ...
            <div class="alert alert-success alert-dismissible <?php if(isset($data)){if($data!=1){echo 'hidden';}}?>">
              ...
              <div class="input-group">
                ...
                <select name="rol" class="form-control" required>
                    <option valule="Admin">Admin</option>
                    <option valule="Usuario">Usuario</option>
                    <option valule="Invitado">Invitado</option>
                  </select>
              </div>
              <!-- /input-group -->
            </div>
