...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/bootstrap/css/global-theme.css">
  <!-- Bootstrap 3.3.6 -->
...
<div class="wrapper">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url(); ?>administrar/usuarios"><i class="fa fa-circle-o"></i>Usuarios</a></li>
            <li><a href="<?php echo base_url(); ?>administrar/dispositivos"><i class="fa fa-circle-o"></i>Dispositivos</a></li>
            <li><a href="<?php echo base_url(); ?>administrar/asociacion"><i class="fa fa-circle-o"></i>Asociación</a></li>
          </ul>
        </li>
        <?php } ?>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2017 <a href="#">Team</a>.</strong> All rights
    reserved.
  </footer>
